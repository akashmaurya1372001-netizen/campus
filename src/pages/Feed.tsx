      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex bg-gray-100 p-1 rounded-xl">
          ...
          <button
            ...
            className={`px-4 py-1.5 rounded-lg text-sm font-medium transition-all ${
              filter === 'issue' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'
            }`}
          >
            Issues
          </button>
          <button
            ...
            className={`px-4 py-1.5 rounded-lg text-sm font-medium transition-all ${
              filter === 'poll' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'
            }`}
          >
            Polls
          </button>
          <button
            ...
            className={`px-4 py-1.5 rounded-lg text-sm font-medium transition-all ${
              filter === 'discussion' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'
            }`}
          >
            Discussions
          </button>
